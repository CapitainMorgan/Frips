...
import { MenuItem ,IconButton,Dialog } from "@material-ui/core";
...
import { brand } from "../staticItems/staticItemName";
...
const BrandForm = ({mobile,field,form,...props}) =>{
    ...
    const BrandInfo = useSelector(state => state?.itemInfo?.itemInfo?.brandInfo)
    ...
    const handleText = (text) =>{
      ...
      const brandCatalogue = () =>{
            ...
            console.log(field)
              return (
                <Box  style={{width:"100%", overflow:"auto" }} maxHeight={mobile ? "none" : 250}>
                  {suggestion.map(item=>{
                      ...
                      if(!item.pasDispo){
                        ...
                        >
                            ...
                            checked={item.Name===field.value} className={classes.checkBox} 
                            inputProps={{
                         ...
                         return( <Box>
                          <Box className={classes.BoxItem} display="flex" alignItems="center" >
      ...
      {!mobile ?
                        ...
                        <Dialog open={Boolean(anchorEl)}>
                            <Box className={classes.Dialog} display="flex" flexDirection="column" >
                                <Box minHeight={80} display="flex" flexDirection="column" justifyContent="center" alignItems="center" position="relative">
                                    <Typography>
                                        Marque
                                    </Typography>
                                ...
                                <Box  style={{backgroundColor:"white",overflow:"auto"}} width={"100%"}>
