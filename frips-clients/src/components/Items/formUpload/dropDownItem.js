...
const DropDownItem = ({field,form,mobile,size,setSize,...props}) =>{
    ...
    const Catalogue = useSelector(state => state?.itemInfo?.itemInfo?.infoCategory) 
                       ...
                       InputProps={{
                        ...
                        open={Boolean(anchorEl)}>
                            <Box style={{backgroundColor:"white",position:"absolute"}} width={"100%"}  >
                                {listCategorie(field.value,navigationValue,setNavigationValue,classes,form,handleClickAway,setSize)}
                                    </Box>
                            </Popper>
                        :
                        ...
                        <Dialog open={Boolean(anchorEl)}>
                            <Box className={classes.Dialog} display="flex" flexDirection="column" >
                                ...
                                {listCategorie(field.value,navigationValue,setNavigationValue,classes,form,handleClickAway,setSize,mobile)}
