import { Box,Card,CardHeader,IconButton,Avatar,CardActionArea,Typography,Divider } from '@material-ui/core'
import React,{useEffect,useMemo} from 'react'
import { connect,useDispatch,useSelector } from 'react-redux'
import { addFavorite, fetchNewItems, removeFavorite } from '../../../actions'
...
const renderedItem = (state,classes,favorite,dispatch,history) =>{
    ...
    if(index === state.length-1){
        return(
            <Box width={"100%"} height={"100%"} padding={1} display="flex" alignItems="center" justifyContent="center" >
                <Card className={classes.BoxOneItem} style={{backgroundColor:"#f5f6f7",borderRadius:5,opacity:0.6}} > 
              
                  <Box display="flex" alignItems="center" justifyContent="center" style={{width:"100%",height:"100%"}}>
                  <CardActionArea style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center"}} onClick={()=>{
