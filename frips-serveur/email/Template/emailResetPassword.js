const sendResetPassword = (token) => {
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <a href="http://localhost:3000/reset-password/${token}" style="display: block; width: 100%; max-width: 400px; margin: 20px auto; background-color: #82a0c2; color: #fff; font-size: 16px; text-align: center; text-decoration: none; padding: 20px; border-radius: 3px;">Réinitialiser mon mot de passe</a>
