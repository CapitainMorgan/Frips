const emailUser = (name) =>{
    ...
    <body style="background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,Oxygen-Sans,Ubuntu,Cantarell,&quot;Helvetica Neue&quot;,sans-serif">
      ...
      <p style="font-size: 17px; line-height: 24px; margin: 16px 0; text-align: left;">
        ...
        <br>
        Vous pouvez dès maintenant explorer notre marketplace et découvrir des milliers d'articles de mode d'occasion. Vous pouvez également ajouter vos propres articles et commencer à vendre.<br>
        <br>
